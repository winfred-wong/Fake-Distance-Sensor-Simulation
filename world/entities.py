import numpy as np
from FakeDistanceSensorSimulation.physics.geometry import Point, Rectangle
...
class Entity:
    def __init__(self, center: Point, heading: float, movable: bool = True, friction: float = 0):
        self.heading_in_angle = np.rad2deg(heading)
    ...
    def speed(self) -> float:
        return self.velocity.norm(2) if self.movable else 0
